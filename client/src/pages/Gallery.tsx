...
export default function Gallery() {
  ...
  return (
    <div className="container py-12">
      ...
      {/* Instagram埋め込みフィード */}
      <div className="mb-12 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 rounded-lg p-8 border border-purple-200 dark:border-purple-800">
        ...
        {/* Instagram埋め込みiFrame */}
        <div className="mb-6 flex justify-center overflow-x-auto pb-4">
          <iframe
