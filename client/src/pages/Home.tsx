      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 dark:from-yellow-300 dark:via-yellow-200 dark:to-yellow-100 relative overflow-hidden geometric-pattern premium-section" ref={soccerPowerRef}>
        ...
        <div className="container relative z-10" ref={soccerPowerParallaxRef}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div className="text-white dark:text-black animate-fade-in-up">
              <div className="flex items-center gap-3 mb-4">
                <Zap className="h-8 w-8 text-yellow-300 dark:text-black" />
                <h3 className="text-sm font-bold tracking-wider text-yellow-300 dark:text-black">
                  サッカーの力
                </h3>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight relative pb-6 text-white dark:text-black">
                子供の創造性を<br />のばせるスポーツ
                <span className="absolute bottom-0 left-0 w-24 h-1 bg-gradient-to-r from-yellow-300 to-yellow-400 rounded-full" />
              </h2>
              <p className="text-lg text-white dark:text-black leading-relaxed">
              ...
              <div className="bg-white/10 dark:bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 dark:border-white/20">
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-white dark:text-black font-semibold">初造性の発展</p>
                      <p className="text-white/70 dark:text-gray-900 text-sm">自分らしい表現を学ぶ</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="bg-yellow-300 dark:bg-blue-200 rounded-full p-2 mt-1">
                      <Heart className="h-5 w-5 text-blue-600 dark:text-black" />
                    </div>
                    <div>
                      <p className="text-white dark:text-black font-semibold">チームワーク</p>
                      <p className="text-white/70 dark:text-gray-900 text-sm">仲間との絆を深める</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="bg-yellow-300 dark:bg-blue-200 rounded-full p-2 mt-1">
                      <Trophy className="h-5 w-5 text-blue-600 dark:text-black" />
                    </div>
                    <div>
                      <p className="text-white dark:text-black font-semibold">人間形成</p>
                      <p className="text-white/70 dark:text-gray-900 text-sm">紳士的な人格を育成</p>
                    </div>
                  </div>
                </div>
              </div>
