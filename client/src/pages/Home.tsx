                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 dark:text-black text-sm">自分らしい表現を学ぶ</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 dark:text-black text-sm">仲間との絆を深める</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="bg-yellow-300 dark:bg-blue-200 rounded-full p-2 mt-1">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 dark:text-black text-sm">紳士的な人格を育成</p>
                    </div>
                  </div>
                </div>
              </div>
