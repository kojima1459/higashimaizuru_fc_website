...
export function InstagramFeed() {
  ...
  useEffect(() => {
    ...
    const loadInstagramScript = () => {
      ...
      script.onerror = () => {
        console.error("Instagram埋め込みスクリプトの読み込みに失敗しました");
      };
      ...
      <div className="container">
        ...
        <div className="flex justify-center">
          <blockquote
            ...
            data-instgrm-permalink="https://www.instagram.com/higashimaizurufc/?utm_source=ig_embed&amp;utm_campaign=loading"
          ...
          >
            <div style={{ padding: "16px" }}>
              <a
                href="https://www.instagram.com/higashimaizurufc/?utm_source=ig_embed&amp;utm_campaign=loading"
                style={{
                  background: "#FFFFFF",
                  lineHeight: 0,
                  padding: "0 0",
