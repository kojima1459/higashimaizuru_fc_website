    ...
    <>
      ...
      {mobileMenuOpen && (
        <>
          ...
          {/* メニューパネル */}
          <div 
            className="fixed left-0 right-0 md:hidden bg-slate-900/98 backdrop-blur-md border-t border-amber-400/20 shadow-2xl overflow-y-auto" 
            style={{ top: '64px', maxHeight: 'calc(100vh - 64px)', zIndex: 50 }}
          >
            <nav className="py-2">
              {navItems.map((item) => {
